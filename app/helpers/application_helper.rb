module ApplicationHelper
  ...
  def state_select(form, attribute)
    state_list = ['','- US -', 'AL','AK','AZ','AR','CA','CO','CT','DE','FL','GA','HI','ID','IL','IN',
   					'IA','KS','KY','LA','ME','MD','MA','MI','MN','MS','MO','MT','NE','NV','NH','NJ','NM','NY',
   					'NC','ND','OH','OK','OR','PA','RI','SC','SD','TN','TX','UT','VT','VA','WA','WV','WI','WY',
   					'-Canada-','AB','BC','MB','NL','NT','NS','NU','ON','PE','QC','SK','YT']
  	form.select(attribute, state_list, {})
  end
  
  def best_state_list
    [['', ''],[nil, '- US -'], ['AL', 'AL'],['AK', 'AK'],['AZ', 'AZ'],['AR', 'AR'],['CA', 'CA'],['CO', 'CO'],['CT', 'CT'],['DE', 'DE'],['FL', 'FL'],
    ['GA', 'GA'],['HI', 'HI'],['ID', 'ID'],['IL', 'IL'],['IN', 'IN'],
   	...
   	[nil, '- Canada -'],['AB','AB'],['BC','BC'],['MB','MB'],['NL','NL'],['NT','NT'],['NS','NS'],['NU','NU'],['ON','ON'],
